 ...
 */
public class RedisExplodedTicketRegistry {
...
//        }
//        Jedis jedis = pool.getResource();
//        Map<String, String> ticketStrMap = jedis.hgetAll(ticketPrefix);
//        Map<String, T> ticketMap = new HashMap<>();
//        for (Map.Entry<String, String> entry : ticketStrMap.entrySet()) {
//            T ticket = str2ticket(entry.getValue(), clazz);
